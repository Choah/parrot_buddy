...
- 상태 박스를 숨기고, 앵무새 클릭으로 다시 표시
- 작업 중에는 macOS 메뉴바 앵무새 아이콘이 흔들흔들 움직임
- Dock에 뜨지 않고 메뉴바 아이콘으로 보이기, 숨기기, 재시작, 종료
- 앵무새 드래그, Command+앵무새 드래그, 상태 박스 드래그, 실제 투명 창 영역 크기 조정 지원
...
- 앵무새 1회 클릭: 또잉 애니메이션
- 상태 박스가 숨겨진 상태에서 앵무새 1회 클릭: 상태 박스 다시 표시
...
- 메뉴바 앵무새 아이콘 클릭: Parrot Buddy 창과 현재 상태 박스 표시
